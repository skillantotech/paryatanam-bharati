  ...
  return (
    <section className="mb-10">
      <div className="max-w-7xl mx-4 xl:mx-auto flex flex-row items-center justify-start gap-2 text-base font-semibold my-5 text-blue-500">
        ...
        /<div className="item text-gray-900">Contact us</div>
      </div>
      <div className="mx-4 xl:mx-auto max-w-7xl">
        ...
        <div className="max-w-5xl mx-auto mt-12 sm:mt-16">
          <div className=" grid grid-cols-1 gap-6 text-center md:px-0 sm:grid-cols-2 md:grid-cols-3">
            ...
            <div className="overflow-hidden sm:col-span-2 md:col-auto  bg-gray-100 rounded-xl">
              <div className="p-6">
                <svg
                  className="flex-shrink-0 w-10 h-10 mx-auto text-gray-400"
                  xmlns="http://www.w3.org/2000/svg"
