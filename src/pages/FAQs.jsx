...
const FaqPage = () => {
  ...
  return (
    <>
      <section className="h-[68vh] flex items-center bg-no-repeat bg-cover bg-[url('https://nebulaaitsolutions.com/assets/images/faq-banner.webp')]">
        <div className="max-w-7xl mx-auto  ">
          <div className="  flex flex-col gap-4 text-white">
            <h2 className="text-3xl md:text-4xl lg:text-5xl  text-center mx-4  leading-tight font-bold">
              Frequently Asked Questions
            </h2>
            <h3 className="mt-3 text-center lg:text-lg font-semibold mx-4">
      ...
      <div className="mt-8">
        <div className="max-w-7xl mx-auto text-center flex justify-center text-3xl ">
          <div className="mx-4">These are some of the most asked Questions</div>
        </div>
        <div className="my-4">
                  ...
                  {e.qna.map((item, i) => (
                    <div key={`${e.category}-${i}`} className="flex gap-4">
                      <div className="flex rounded-full">
                        <span className=" flex text-lg text-blue-600 h-fit bg-blue-100 rounded-full p-2">
                          {<FaQuestion />}
                        </span>
                      </div>
