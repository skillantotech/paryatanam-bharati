...
import HandpickedCollection from "../../components/TransportationPages/HandpickedCollection/HandpickedCollection";
import HotelsBookingFAQs from "../../components/AccomodationPages/AccomodationFAQs/HotelsBookingFAQs";
...
const Hotels = () => {
  ...
  return (
    <div>
      <section
        className="py-20 bg-cover bg-[0px_-280px] flex items-center justify-center md:h-[85vh]"
        style={{
          backgroundImage:
