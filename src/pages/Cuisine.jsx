  ...
  return (
    <>
      ...
      <div className="max-w-7xl mx-4 xl:mx-auto ">
        ...
        <div className="text-3xl my-5 ">Quench Your Thirst with India's Finest Beverages</div>
        ...
        <div className="text-3xl my-10 ">Traditional Dishes for Every Indian Celebration</div>
