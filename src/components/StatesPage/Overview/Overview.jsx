...
return (
  <div className="max-w-7xl mx-4 xl:mx-auto mt-8 mb-12">
    <div className="prose lg:prose-xl">
      ...
      <p className="mb-2">
        The major tourist attractions of Rajasthan are its havelis, palaces and
        forts that add to the experience of exploring one of the historically
        wealthy states in India. Some of the most famous and most visited forts
        in Rajasthan are Chittorgarh, Mehrangarh, Jaisalmer, Jaigarh and
        Junagadh Forts. Of these, the Mehrangarh Fort in Jodhpur is spread over
        5 kilometers and stands on a hill almost 125 kilometers high.
        Chittorgarh Fort is also a must-visit tourist attraction, as it’s the
        largest fort in Asia. It is spread over an area of 700 acres, extending
        to 3 km in length and 13 km in peripheral length. The exquisite
        architecture isn’t only confined to the palaces and forts as Rajasthan
        also boasts impressive Hindu & Jain temples like Dilwara Jain Temples
        and Eklingji Temple.
      </p>
      ...
      <p className="mb-2">
        ...
        birdwatching. Some of the famous wildlife sanctuaries and national parks
        of the state are Ranthambore National Park, Sariska National Park,
        Keoladeo and Mukundra Hills National Park. It is blessed with a rich
        variety of vegetation and animal & bird species. To spot the Royal
        Bengal Tigers, Ranthambore National Park and Sariska National Park are
        the most famous wildlife destinations in Rajasthan.
      </p>

      <p className="mb-2">
        Those who love birdwatching should visit Keoladeo National Park
        (Bharatpur Bird Sanctuary), a UNESCO World Heritage Site, as it is home
        to at least 230 species of birds. Home to indigenous water birds and
        migratory water birds, specifically the Siberian Crane, the Bharatpur
        Sanctuary also boasts many species of mammals like Sambar, Chital,
        Nilgai and Boar. It is a major tourist spot for most ornithologists
        during the hibernal season. Apart from these, Rajasthan is home to a
        large number of leopards, blackbuck, great Indian spotted eagle, and
        marsh crocodiles.
      </p>
      ...
      <p className="mb-2">
        ...
        skills, shopping for which is an experience to have. The state is famous
        for its jewellery pieces, and is one of the largest centers for hand cut
        gems in the world. Gold and silver jewellery is extremely famous, along
        with Kundan and Meenakari styles of ornaments. The gold work on glass,
        called Thewa is also quite a popular thing to buy in Rajasthan.
      </p>
      ...
      <p className="mb-2">
        ...
        hotels that along with offering incredible hospitality to all its guests
        also cater to the fantasies of honeymoon couples. There are several ways
        that you can experience both luxury and royal hospitality in Rajasthan.
        One of these is taking a ride on the Royal Rajasthan on Wheels Train
        where you can sink into a relaxing massage session; sample spicy
        Rajasthani cuisine in a restaurant and bar-cum-lounge; relaxing stay in
        twin-bedded chambers with attached bathrooms and pampering session in
        the well-furnished salon, while enjoying the pretty view of the desert
        rolling by.
      </p>
      ...
      <p className="mb-2">
        ...
        activities like zorbing, cycling and ATV bike ride. In Pushkar, you can
        enjoy hot air balloon rides, quad biking and camel safari. And of
        course, with Rajasthan being home to the great sand dunes of the Thar
        desert, you can enjoy camel rides, feel the thrill of sand dune bashing
        and biking. You can also enjoy parasailing and enjoy the views of the
        forts and desert from above.
      </p>
      <div
      ...
      <div
        ...
        style={{
          ...
          height:
            visibleDestinations < destinations.length ? "auto" : contentHeight,
          overflow: "hidden",
        }}
      >
