        ...
        <div className="best-time-visit-main">
          <div className="heading-h2 flex justify-between items-center mb-8">
            ...
            <div className="view-tours">
              <a
                href="#"
                className=" border-2 border-blue-500 rounded p-4  hover:bg-blue-700 bordertext-indigo-600 hover:text-white"
              >
                View more
              </a>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="best-box bg-gray bg-opacity-50 p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300">
              <div className="best-visit-ico mb-4">
                <img
                  src="https://www.tourmyindia.com/states/rajasthan/image/train.png"
              ...
              <div className="best-visit-details text-center">
                ...
                <p className="text-gray-600">
                  Summer in Rajasthan starts from April and lasts till June. The
                  temperature ranges from 24&deg;C to 48&deg;C. Heat can be very
                  uncomfortable for tourists. This season is not favourable for
                  travel.
                </p>
              </div>
            </div>
            ...
            <div className="best-box bg-gray bg-opacity-50 p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300">
              <div className="best-visit-ico mb-4">
                <img
                  src="	https://www.tourmyindia.com/states/rajasthan/image/air.png"
              ...
              <div className="best-visit-details text-center">
                ...
                <p className="text-gray-600">
                  Monsoon in Rajasthan begins in July and ends in September. The
                  temperature ranges from 21&deg;C to 35&deg;C. During Monsoon
                  thunderclap paves the way for heavy rainfall. This season is
                  also favourable for travel.
                </p>
              </div>
            </div>
            ...
            <div className="best-box bg-gray bg-opacity-50 p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300">
              <div className="best-visit-ico mb-4">
                <img
                  src="https://www.tourmyindia.com/states/rajasthan/image/bus.png"
