  ...
  return (
    <section className="max-w-7xl lg:mx-auto flex mx-4 md:px-4 lg:flex-row xl:px-0 flex-col gap-10 my-10 overflow-hidden">
      <div className="max-w-full">
        <div className="bg-red-500 text-white py-0.5 px-0.5 rounded-lg text-center max-w-12 text-xs">
          Dance
        </div>
        ...
        <p className="text-lg">
          ...
          nesciunt vitae libero, eveniet numquam perspiciatis ipsam impedit nam
          debitis odit labore ipsum similique velit? Eos animi voluptates
          aliquam delectus!
          <br></br>
          <br></br>
          Tenetur voluptatum reiciendis inventore esse sequi at corporis iusto?
          Rerum neque ipsa voluptates iure, consequatur incidunt atque
          perferendis molestiae sed nobis omnis perspiciatis, quae non expedita
          obcaecati tempora molestias repellat.
        </p>
