...
// import packageImage from "../../../assets/images/Tall Buddha Statue.png"

const ExplorePackageSection = () => {
  return (
    <div className="flex h-90vh max-w-7xl mx-auto mt-20">
      <div className="w-1/2 flex items-center justify-center">
        {/* Replace 'image.jpg' with your image source */}
        <img
      ...
      <div className="w-1/2 flex flex-col justify-center px-8 relative">
        ...
        <p className="text-base">
          ...
          exclusive experiences. Whether you&apos;re looking for a relaxing beach
          gateaway, an adventurous trek through the mountains, or a cultural
          immersion in a vibrant city, we have perfect itinerary for you.
        </p>
        <div className="mt-6">
