...
const HeroSection = () => {
  return (
    <div className="relative h-[calc(100dvh-96px)] overflow-hidden">
      {/* Video Background */}
      ...
      {/* Hero Contents */}
      <div className="h-full flex flex-col items-center justify-around text-center text-white z-[1] ">
        <div className="hero-texts mt-12">
          <h3 className="text-3xl md:text-4xl lg:text-5xl font-semibold mx-auto w-[90%] md:w-[60%] lg:w-[50%]">
            Discover the Magic of India&apos;s Landmarks
          </h3>
          <p className="text-base py-4 px-5 mx-auto w-[90%] md:w-[60%] lg:w-[50%]">
          ...
          <div className="hero-buttons py-2 flex flex-row justify-center items-center gap-5">
            <button className="bg-white text-black py-2 px-4 border border-white hover:bg-slate-200 transition-all duration-500 ease-in-out rounded-sm">
              Explore
            </button>
