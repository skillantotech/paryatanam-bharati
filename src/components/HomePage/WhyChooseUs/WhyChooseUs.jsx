    ...
    >
      ...
      <div className="flex flex-wrap justify-center mt-10 ">
        <div className="py-4 px-2 sm:p-4 w-80 sm:w-96 h-[400px] sm:h-[430px] ">
          ...
          >
            <div
              className="absolute left-0 top-[82%] bg-black-tobottom flex h-full flex-col z-5 p-8 max-w-sm group-hover:top-0 ease-linear duration-200"
              // style={{
              //   background:
        ...
        <div className="py-4 px-2 sm:p-4 w-80 sm:w-96 h-[400px] sm:h-[430px]">
          ...
          >
            <div
              className="absolute left-0 top-[82%] flex h-full bg-black-tobottom flex-col z-5 p-8 max-w-sm group-hover:top-0 ease-linear duration-200"
              // style={{
              //   background:
              //     "linear-gradient(to bottom, transparent 0%, black 100%)",
              // }}
