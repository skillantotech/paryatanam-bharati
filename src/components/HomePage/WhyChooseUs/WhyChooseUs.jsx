import Image1 from "../../../assets/images/why-choose-us/pexels-rahul-dogra-1439977-2779325.jpg";
import Image2 from "../../../assets/images/why-choose-us/pexels-parv-choudhary-724334-2870167.jpg";
import Image3 from "../../../assets/images/why-choose-us/pexels-agnieszka-palmowska-23342-631909.jpg";
    ...
    >
      ...
      <div className="flex flex-wrap items-center justify-center xl:justify-between mt-10 ">
        {BrandFeatures.map((feature, i) => (
          ...
          >
            <div
              className="object-cover flex rounded-lg h-full p-8 flex-col relative overflow-hidden group"
              style={{
