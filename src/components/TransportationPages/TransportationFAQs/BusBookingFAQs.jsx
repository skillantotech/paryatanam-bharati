...
const BusBookingFAQs = () => {
  const faqs = [
    ...
    },
    {
      ...
      answer:
        "It is advisable to arrive at the bus station at least 30 minutes before the scheduled departure time of your bus. This allows you ample time to check-in, locate your boarding gate or platform, and handle any last-minute details. If you are traveling from a busy terminal or during peak travel times, consider arriving earlier to avoid any delays. Buses usually start boarding 15 minutes before departure, so being punctual is key to a smooth travel experience.",
    },
  ];
