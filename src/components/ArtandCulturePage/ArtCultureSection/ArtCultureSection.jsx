...
const ArtCultureSection = () => {
  return (
    <div className="flex flex-col lg:flex-row max-w-7xl mx-4 xl:mx-auto gap-4 my-4">
      <div className="lg:w-1/2 flex flex-col justify-center text-center md:p-6">
      ...
      <div className="lg:w-1/2 h-96 rounded-lg overflow-hidden">
        <img
          className="w-full h-full object-cover shadow-md transform transition-transform duration-500 ease-in-out hover:scale-105"
