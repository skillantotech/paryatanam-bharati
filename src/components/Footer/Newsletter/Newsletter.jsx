        ...
        <div className="Newsletter-form mt-3 sm:mt-0">
          <form action="" className=" flex gap-2 flex-wrap">
            ...
            <button
              type="submit"
              value="Submit"
              className=" h-8 px-3 border max-[400px]:w-[100%] border-gray-800 bg-white text-black transition-all duration-300 ease-linear hover:border-gray-700 hover:bg-transparent hover:backdrop-blur-md hover:text-white"
            >
              Submit
            </button>
          </form>
