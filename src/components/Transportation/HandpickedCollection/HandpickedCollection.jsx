...
// Function to chunk the array into groups of objects
...
const HandpickedCollection = () => {
  const exploreReview5 = chunkArray(HandpickedCollectionData, 5);
  const exploreReview3 = chunkArray(HandpickedCollectionData, 3);
    ...
    <section className="relative mt-12 max-w-7xl mx-4 xl:mx-auto mb-20">
      ...
      <div className="w-full">
        <Carousel theme={customTheme} slideInterval={2000} pauseOnHover>
          {windowWidth <= 460
            ? chunkArray(HandpickedCollectionData, 1).map((group, index) => (
                  ...
                  {group.map((item) => (
                    ...
                    >
                      ...
                      <div className="absolute top-0 left-0 w-full h-[200px] flex items-end justify-center bg-transparent rounded-lg transition-colors duration-300 hover:bg-black/50">
                        ...
                        <h3 className="text-2xl text-white font-bold text-center z-10 mb-2">
                          {item.tourname}
                        </h3>
                      </div>
                    </div>
