  ...
  return (
    <>
      <div className="max-w-7xl xl:mx-auto my-10">
        ...
        <div className={`${windowWidth ? 'flex overflow-x-scroll gap-8 whitespace-nowrap mt-5 ': 'grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 place-items-center gap-8 mx-auto mt-5'}  `}>
          {!windowWidth ? data.slice(0,visibleItems).map((dishes, index) => (
            ...
            <div key={index} className=" w-64 pb-1 md:pb-0 md:w-80 relative">
        ...
        {!windowWidth && <div className="flex justify-center mt-10">
          <a
