  ...
  return (
    <div className=" my-5">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <Link
          to={"cuisine-details"}
          className="md:col-span-2 md:row-span-2 relative overflow-hidden rounded shadow-lg group "
        >
          <img
        ...
        <Link
          to={"cuisine-details"}
          className="relative overflow-hidden rounded shadow-lg group col-span-2 md:col-auto"
        >
          <img
        ...
        <Link
          to={"cuisine-details"}
          className="relative overflow-hidden rounded shadow-lg group md:row-span-2"
        >
          <img
        ...
        <Link
          to={"cuisine-details"}
          className="relative overflow-hidden rounded shadow-lg group row-span-2 md:row-auto "
        >
          <img
