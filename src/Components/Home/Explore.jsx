...
const Explore = () => {
  return (
    <>
      <h5 className="pb-3">Latest</h5>
      <h2 className="text-3xl font-bold pb-4">Explore the Beauty of India</h2>
      <h5>Discover the wonders of india through our blogs posts</h5>
      <div className="flex">
